...
def create_multipart_data(file_data: bytes, filename: str = "test.bin") -> Tuple[bytes, str]:
...
def run_comprehensive_benchmark(args):
    ...
    for result in results:
        ...
        print(f"{data_mb}MB{'':<6} {chunk_kb}KB{'':<8} {throughput:.1f} MB/s{'':<3} +{memory_mb:.1f}MB")
